...
export default function Pagination({
  ...
  return (
    <div className="fixed bottom-0 right-0 mr-10 items-center border-t border-gray-200 bg-white px-4 py-3 sm:px-6">
      <div className="flex justify-end items-center gap-10">
        <div>
          <p className="text-sm text-gray-700">
            Showing <span className="font-medium">{startPoint}</span> to{" "}
            <span className="font-medium">{endPoint}</span> of{" "}
        ...
        >
          ...
          <a
            ...
            onClick={() =>
              setCurrentPage((x) => (x + 1 > totalPages ? x : x + 1))
            }
          >
